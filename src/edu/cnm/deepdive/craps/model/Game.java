 ...
 *
 * @author James Mattos &amp; Deep Dive Coding Java + Android cohort 6
 * @version 1.0
 *
 */
public class Game {
  ...
  /**
   * Plays one round of Craps, from come-out roll to win or loss. if this is invoked
   * on an instance already in a terminal state ({@link State#WIN} or
  ...
  /**
   * Constructs and returns a deep (safe) copy of the list of rolls in the current game.
   *
   * @return
   */
